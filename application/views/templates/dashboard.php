...
<head>
	...
	<title><?= $title; ?> | App Inventori Laboran Farmasi</title>
			...
			<li class="nav-item">
				...
				<div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-light py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="<?= base_url('satuan'); ?>">Jenis</a>
						<a class="collapse-item" href="<?= base_url('jenis'); ?>">Kategori</a>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<nav class="navbar navbar-expand navbar-dark bg-gardient-warning topbar mb-4 static-top shadow-sm">
					...
					<div class="sidebar-brand-text mx-2"><strong>LABORAN</strong>
						<a class="sidebar-brand-text mx-2" style="text-decoration:none; color:#800080">FARMASI</a>
						<strong class="sidebar-brand-text" style="text-decoration:none; color:#ffa500">STIKes Bogor Husada</strong>
					</div>
			...
			<footer class="sticky-footer bg-light">
				<div class="container my-auto">
					<div class="copyright text-center my-auto">
						<span>Copyright &copy; Aplikasi G-Inventory &bull; 2021 &bull; by <?= anchor('https://kasetya02.blogspot.com/', 'KaSetya'); ?></span>
					</div>
				</div>
			</footer>
			<!-- End of Footer -->
